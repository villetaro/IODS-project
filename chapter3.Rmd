...
Now lets make a model based on the plots above. I'm trying to explain high usage of alcohol with grades, sex and age. I'm logistic regression model below.
